...
import WagmiWallets from '../src/components/WagmiWallets';
    ...
    <>
      ...
      {/* <div className="max-w-4xl m-auto p-4 md:p-0 md:flex md:h-screen md:items-center md:justify-between ">
        ...
        <div className='md:mx-12'>
          ...
          <p className="mt-12 text-xl  text-white " >Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
